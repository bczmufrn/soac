<?php /* Smarty version 2.6.26, created on 2016-03-31 18:36:43
         compiled from conference/current.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'conference/current.tpl', 18, false),array('function', 'url', 'conference/current.tpl', 21, false),array('block', 'iterate', 'conference/current.tpl', 20, false),array('modifier', 'escape', 'conference/current.tpl', 21, false),array('modifier', 'nl2br', 'conference/current.tpl', 24, false),array('modifier', 'date_format', 'conference/current.tpl', 27, false),)), $this); ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['schedConf']->getFullTitle())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
		...
		<p>
			<?php if ($this->_tpl_vars['schedConf']->getSetting('locationName')): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['schedConf']->getSetting('locationName'))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
<br /><?php endif; ?>
			<?php if ($this->_tpl_vars['schedConf']->getSetting('locationAddress')): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['schedConf']->getSetting('locationAddress'))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
<br /><?php endif; ?>
