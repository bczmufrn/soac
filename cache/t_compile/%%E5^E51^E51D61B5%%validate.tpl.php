<?php /* Smarty version 2.6.26, created on 2016-05-19 15:37:31
         compiled from rtadmin/validate.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'rtadmin/validate.tpl', 16, false),array('function', 'url', 'rtadmin/validate.tpl', 30, false),array('block', 'iterate', 'rtadmin/validate.tpl', 18, false),array('modifier', 'escape', 'rtadmin/validate.tpl', 20, false),array('modifier', 'validate_url', 'rtadmin/validate.tpl', 26, false),array('modifier', 'truncate', 'rtadmin/validate.tpl', 30, false),array('modifier', 'to_array', 'rtadmin/validate.tpl', 30, false),)), $this); ?>
<?php echo ''; ?><?php $this->assign('pageTitle', "rt.admin.validateUrls"); ?><?php echo ''; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
<div id="version">
	<h3><?php echo ((is_array($_tmp=$this->_tpl_vars['version']->getTitle())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</h3>
	<ul>
...
?>
		<li><?php echo ((is_array($_tmp=$this->_tpl_vars['context']->getTitle())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
?>
			<br />
			<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "rt.admin.validateUrls.urlIsInvalid",'url' => ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['error']['url'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 50) : $this->_plugins['modifier']['truncate'][0][0]->smartyTruncate($_tmp, 50)))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp))), $this);?>
