<?php /* Smarty version 2.6.26, created on 2016-04-05 18:25:24
         compiled from submission/comment/peerReviewComment.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'ord', 'submission/comment/peerReviewComment.tpl', 21, false),array('modifier', 'chr', 'submission/comment/peerReviewComment.tpl', 23, false),array('modifier', 'date_format', 'submission/comment/peerReviewComment.tpl', 28, false),array('modifier', 'to_array', 'submission/comment/peerReviewComment.tpl', 40, false),array('modifier', 'escape', 'submission/comment/peerReviewComment.tpl', 40, false),array('modifier', 'strip_unsafe_html', 'submission/comment/peerReviewComment.tpl', 47, false),array('modifier', 'nl2br', 'submission/comment/peerReviewComment.tpl', 47, false),array('function', 'translate', 'submission/comment/peerReviewComment.tpl', 23, false),array('function', 'url', 'submission/comment/peerReviewComment.tpl', 40, false),array('function', 'fieldLabel', 'submission/comment/peerReviewComment.tpl', 74, false),)), $this); ?>
...
<?php $_from = $this->_tpl_vars['paperComments']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
 ...
 <?php echo ((is_array($_tmp=$this->_tpl_vars['reviewLetters'][$this->_tpl_vars['reviewId']]+$this->_tpl_vars['start'])) ? $this->_run_mod_handler('chr', true, $_tmp) : chr($_tmp)); ?>
	...
	<td width="75%">
		<?php if ($this->_tpl_vars['comment']->getAuthorId() == $this->_tpl_vars['userId'] && ! $this->_tpl_vars['isLocked']): ?>
			<div style="float: right"><a href="<?php if ($this->_tpl_vars['reviewId']): ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editComment','path' => ((is_array($_tmp=$this->_tpl_vars['paperId'])) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['comment']->getId()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['comment']->getId())),'reviewId' => $this->_tpl_vars['reviewId']), $this);?>
<?php else: ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editComment','path' => ((is_array($_tmp=$this->_tpl_vars['paperId'])) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['comment']->getId()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['comment']->getId()))), $this);?>
<?php endif; ?>" class="action"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.edit"), $this);?>
</a>&nbsp;|&nbsp;<a href="<?php if ($this->_tpl_vars['reviewId']): ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'deleteComment','path' => ((is_array($_tmp=$this->_tpl_vars['paperId'])) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['comment']->getId()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['comment']->getId())),'reviewId' => $this->_tpl_vars['reviewId']), $this);?>
<?php else: ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'deleteComment','path' => ((is_array($_tmp=$this->_tpl_vars['paperId'])) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['comment']->getId()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['comment']->getId()))), $this);?>
...
<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.comments.forAuthorDirector"), $this);?>
</td>
...
<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.comments.forDirector"), $this);?>
</td>
