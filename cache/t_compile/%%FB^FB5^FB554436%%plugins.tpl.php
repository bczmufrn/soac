<?php /* Smarty version 2.6.26, created on 2016-05-18 13:58:58
         compiled from manager/importexport/plugins.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'manager/importexport/plugins.tpl', 18, false),array('function', 'translate', 'manager/importexport/plugins.tpl', 20, false),array('modifier', 'to_array', 'manager/importexport/plugins.tpl', 18, false),array('modifier', 'escape', 'manager/importexport/plugins.tpl', 18, false),)), $this); ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['plugin']->getDisplayName())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
	...
	<?php endforeach; else: ?>
		<li><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.importExport.noPlugins"), $this);?>
</li>
