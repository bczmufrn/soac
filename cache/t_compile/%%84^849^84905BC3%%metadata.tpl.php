<?php /* Smarty version 2.6.26, created on 2016-04-05 11:00:51
         compiled from submission/metadata/metadata.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'submission/metadata/metadata.tpl', 12, false),array('function', 'url', 'submission/metadata/metadata.tpl', 15, false),array('function', 'icon', 'submission/metadata/metadata.tpl', 28, false),array('modifier', 'concat', 'submission/metadata/metadata.tpl', 26, false),array('modifier', 'to_array', 'submission/metadata/metadata.tpl', 27, false),array('modifier', 'strip_tags', 'submission/metadata/metadata.tpl', 27, false),array('modifier', 'assign', 'submission/metadata/metadata.tpl', 27, false),array('modifier', 'escape', 'submission/metadata/metadata.tpl', 28, false),array('modifier', 'strip_unsafe_html', 'submission/metadata/metadata.tpl', 39, false),array('modifier', 'nl2br', 'submission/metadata/metadata.tpl', 39, false),array('modifier', 'default', 'submission/metadata/metadata.tpl', 39, false),)), $this); ?>
<div id="metadata">
...
<?php if ($this->_tpl_vars['mayEditPaper']): ?>
	<p><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'viewMetadata','path' => $this->_tpl_vars['submission']->getPaperId()), $this);?>
" class="action"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.editMetadata"), $this);?>
</a></p>
<?php endif; ?>

<div id="authors">
<h4><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "paper.authors"), $this);?>
</h4>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['author']->getUrl())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
	...
	<tr valign="top">
		...
		<td class="value"><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['author']->getAffiliation())) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : String::stripUnsafeHtml($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)))) ? $this->_run_mod_handler('default', true, $_tmp, "&mdash;") : smarty_modifier_default($_tmp, "&mdash;")); ?>
</td>
	</tr>
	<tr valign="top">
	...
	<tr valign="top">
		...
		<td class="value"><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['author']->getAuthorBiography())) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : String::stripUnsafeHtml($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)))) ? $this->_run_mod_handler('default', true, $_tmp, "&mdash;") : smarty_modifier_default($_tmp, "&mdash;")); ?>
</td>
	</tr>
