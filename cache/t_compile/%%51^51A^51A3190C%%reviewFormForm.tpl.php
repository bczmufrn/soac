<?php /* Smarty version 2.6.26, created on 2016-04-05 18:09:27
         compiled from manager/reviewForms/reviewFormForm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'manager/reviewForms/reviewFormForm.tpl', 14, false),array('function', 'translate', 'manager/reviewForms/reviewFormForm.tpl', 14, false),array('function', 'fieldLabel', 'manager/reviewForms/reviewFormForm.tpl', 32, false),array('function', 'form_language_chooser', 'manager/reviewForms/reviewFormForm.tpl', 37, false),array('modifier', 'assign', 'manager/reviewForms/reviewFormForm.tpl', 34, false),array('modifier', 'escape', 'manager/reviewForms/reviewFormForm.tpl', 44, false),)), $this); ?>
...
<?php if (count ( $this->_tpl_vars['formLocales'] ) > 1): ?>
	<tr valign="top">
		...
		<td width="80%" class="value">
			...
			<?php else: ?><?php echo ((is_array($_tmp=$this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'createReviewForm'), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'reviewFormFormUrl') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'reviewFormFormUrl'));?>
...
" class="button" onclick="document.location.href='<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'reviewForms'), $this);?>
'" /></p>
</form>
