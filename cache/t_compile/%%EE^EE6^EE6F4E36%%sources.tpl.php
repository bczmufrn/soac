<?php /* Smarty version 2.6.26, created on 2016-03-31 17:20:05
...
')"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.delete"), $this);?>
	...
	<tr valign="top">
		...
		<td colspan="1"><label for="defaultAuthId_0"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "admin.auth.ocs"), $this);?>
</label></td>
