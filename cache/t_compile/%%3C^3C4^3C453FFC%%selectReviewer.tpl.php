<?php /* Smarty version 2.6.26, created on 2016-04-05 11:01:00
         compiled from trackDirector/selectReviewer.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'trackDirector/selectReviewer.tpl', 28, false),array('function', 'url', 'trackDirector/selectReviewer.tpl', 29, false),array('function', 'html_options_translate', 'trackDirector/selectReviewer.tpl', 33, false),array('function', 'sort_search', 'trackDirector/selectReviewer.tpl', 55, false),array('function', 'math', 'trackDirector/selectReviewer.tpl', 90, false),array('function', 'page_info', 'trackDirector/selectReviewer.tpl', 114, false),array('function', 'page_links', 'trackDirector/selectReviewer.tpl', 115, false),array('modifier', 'escape', 'trackDirector/selectReviewer.tpl', 40, false),array('modifier', 'string_format', 'trackDirector/selectReviewer.tpl', 76, false),array('modifier', 'date_format', 'trackDirector/selectReviewer.tpl', 95, false),array('modifier', 'default', 'trackDirector/selectReviewer.tpl', 96, false),array('modifier', 'to_array', 'trackDirector/selectReviewer.tpl', 101, false),array('block', 'iterate', 'trackDirector/selectReviewer.tpl', 67, false),)), $this); ?>
...
<h3><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "director.paper.selectReviewer"), $this);?>
</h3>
<form name="submit" method="post" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'selectReviewer','path' => $this->_tpl_vars['paperId']), $this);?>
">
...
?><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'selectReviewer','path' => $this->_tpl_vars['paperId'],'searchInitial' => $this->_tpl_vars['letter']), $this);?>
...
<?php endif; ?></a> <?php endforeach; endif; unset($_from); ?><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'selectReviewer','path' => $this->_tpl_vars['paperId']), $this);?>
...
<p><a class="action" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'enrollSearch','path' => $this->_tpl_vars['paperId']), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "trackDirector.review.enrollReviewer"), $this);?>
</a>&nbsp;|&nbsp;<a class="action" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'createReviewer','path' => $this->_tpl_vars['paperId']), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "trackDirector.review.createReviewer"), $this);?>
</a></p>
...
<tr class="heading" valign="bottom">
	...
	<td width="7%"><?php echo $this->_plugins['function']['sort_search'][0][0]->smartySortSearch(array('key' => "director.submissions.averageTime",'sort' => 'average'), $this);?>
</td>
	<td width="13%"><?php echo $this->_plugins['function']['sort_search'][0][0]->smartySortSearch(array('key' => "director.submissions.lastAssigned",'sort' => 'latest'), $this);?>
</td>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['reviewer']->getFullName())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
	...
	<td><?php echo ((is_array($_tmp=$this->_tpl_vars['reviewer']->getLocalizedInterests())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</td>
...
<?php else: ?>&mdash;<?php endif; ?></td>
	...
	<td>
		...
		<?php else: ?>
		<a class="action" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'selectReviewer','path' => ((is_array($_tmp=$this->_tpl_vars['paperId'])) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['reviewer']->getId()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['reviewer']->getId()))), $this);?>
...
" align="right"><?php echo $this->_plugins['function']['page_links'][0][0]->smartyPageLinks(array('anchor' => 'reviewers','name' => 'reviewers','searchInitial' => $this->_tpl_vars['searchInitial'],'iterator' => $this->_tpl_vars['reviewers'],'searchField' => $this->_tpl_vars['searchField'],'searchMatch' => $this->_tpl_vars['searchMatch'],'search' => $this->_tpl_vars['search'],'dateFromDay' => $this->_tpl_vars['dateFromDay'],'dateFromYear' => $this->_tpl_vars['dateFromYear'],'dateFromMonth' => $this->_tpl_vars['dateFromMonth'],'dateToDay' => $this->_tpl_vars['dateToDay'],'dateToYear' => $this->_tpl_vars['dateToYear'],'dateToMonth' => $this->_tpl_vars['dateToMonth'],'sort' => $this->_tpl_vars['sort'],'sortDirection' => $this->_tpl_vars['sortDirection']), $this);?>
</td>
	</tr>
<?php endif; ?>
</table>
...
<p><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "director.paper.selectReviewerNotes"), $this);?>
</p>
</div>
