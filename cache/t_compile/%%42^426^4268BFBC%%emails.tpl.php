<?php /* Smarty version 2.6.26, created on 2016-04-01 15:35:08
         compiled from manager/emails/emails.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'manager/emails/emails.tpl', 20, false),array('function', 'url', 'manager/emails/emails.tpl', 34, false),array('function', 'page_info', 'manager/emails/emails.tpl', 62, false),array('function', 'page_links', 'manager/emails/emails.tpl', 63, false),array('block', 'iterate', 'manager/emails/emails.tpl', 27, false),array('modifier', 'escape', 'manager/emails/emails.tpl', 29, false),array('modifier', 'replace', 'manager/emails/emails.tpl', 29, false),array('modifier', 'truncate', 'manager/emails/emails.tpl', 32, false),)), $this); ?>
...
<?php $this->_tag_stack[] = array('iterate', array('from' => 'emailTemplates','item' => 'emailTemplate')); $_block_repeat=true;$this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	<tr valign="top">
		<td><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['emailTemplate']->getEmailKey())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)))) ? $this->_run_mod_handler('replace', true, $_tmp, '_', ' ') : smarty_modifier_replace($_tmp, '_', ' ')); ?>
</td>
