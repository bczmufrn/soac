<?php /* Smarty version 2.6.26, created on 2016-04-05 12:10:19
         compiled from manager/people/selectMergeUser.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'manager/people/selectMergeUser.tpl', 16, false),array('function', 'url', 'manager/people/selectMergeUser.tpl', 19, false),array('function', 'html_options_translate', 'manager/people/selectMergeUser.tpl', 30, false),array('function', 'sort_heading', 'manager/people/selectMergeUser.tpl', 74, false),array('function', 'icon', 'manager/people/selectMergeUser.tpl', 94, false),array('function', 'math', 'manager/people/selectMergeUser.tpl', 119, false),array('function', 'page_info', 'manager/people/selectMergeUser.tpl', 119, false),array('function', 'page_links', 'manager/people/selectMergeUser.tpl', 120, false),array('modifier', 'escape', 'manager/people/selectMergeUser.tpl', 37, false),array('modifier', 'wordwrap', 'manager/people/selectMergeUser.tpl', 88, false),array('modifier', 'concat', 'manager/people/selectMergeUser.tpl', 91, false),array('modifier', 'assign', 'manager/people/selectMergeUser.tpl', 92, false),array('modifier', 'to_array', 'manager/people/selectMergeUser.tpl', 93, false),array('modifier', 'truncate', 'manager/people/selectMergeUser.tpl', 94, false),array('modifier', 'count', 'manager/people/selectMergeUser.tpl', 99, false),array('block', 'iterate', 'manager/people/selectMergeUser.tpl', 82, false),)), $this); ?>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.role.managers"), $this);?>
	...
	<li><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('path' => 'directors','oldUserIds' => $this->_tpl_vars['oldUserIds']), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.role.directors"), $this);?>
</a></li>
	<li><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('path' => 'trackDirectors','oldUserIds' => $this->_tpl_vars['oldUserIds']), $this);?>
...
" class="headseparator">&nbsp;</td>
	...
	<tr class="heading" valign="bottom">
		<?php if (empty ( $this->_tpl_vars['oldUserIds'] )): ?>
			<td width="5%">&nbsp;</td>
		<?php endif; ?>
		<td width="29%"><?php echo $this->_plugins['function']['sort_heading'][0][0]->smartySortHeading(array('key' => "user.username",'sort' => 'username'), $this);?>
</td>
