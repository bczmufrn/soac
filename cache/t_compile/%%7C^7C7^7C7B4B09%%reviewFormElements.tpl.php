<?php /* Smarty version 2.6.26, created on 2016-06-01 12:55:52
         compiled from manager/reviewForms/reviewFormElements.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'manager/reviewForms/reviewFormElements.tpl', 29, false),array('function', 'translate', 'manager/reviewForms/reviewFormElements.tpl', 29, false),array('function', 'page_info', 'manager/reviewForms/reviewFormElements.tpl', 73, false),array('function', 'page_links', 'manager/reviewForms/reviewFormElements.tpl', 74, false),array('function', 'html_options', 'manager/reviewForms/reviewFormElements.tpl', 81, false),array('block', 'iterate', 'manager/reviewForms/reviewFormElements.tpl', 50, false),array('modifier', 'escape', 'manager/reviewForms/reviewFormElements.tpl', 53, false),array('modifier', 'strip_tags', 'manager/reviewForms/reviewFormElements.tpl', 54, false),array('modifier', 'truncate', 'manager/reviewForms/reviewFormElements.tpl', 54, false),array('modifier', 'to_array', 'manager/reviewForms/reviewFormElements.tpl', 56, false),)), $this); ?>
<?php $this->assign('pageTitle', "manager.reviewFormElements"); ?>
...
"/></td>
		<td><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['reviewFormElement']->getLocalizedQuestion())) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('truncate', true, $_tmp, 200, "...") : $this->_plugins['modifier']['truncate'][0][0]->smartyTruncate($_tmp, 200, "...")))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</td>
		<td class="nowrap">
...
</a>&nbsp;|&nbsp;<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'moveReviewFormElement','d' => 'u','reviewFormElementId' => $this->_tpl_vars['reviewFormElement']->getId()), $this);?>
...
" class="action">&darr;</a>
	...
	<tr>
		<td colspan="3" class="<?php if ($this->_tpl_vars['reviewFormElements']->eof()): ?>end<?php endif; ?>separator">&nbsp;</td>
	</tr>
