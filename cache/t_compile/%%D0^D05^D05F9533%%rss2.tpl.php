<?php /* Smarty version 2.6.26, created on 2016-04-21 01:22:07
         compiled from /var/www/html/forumrd/lib/pkp/templates/notification/rss2.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/var/www/html/forumrd/lib/pkp/templates/notification/rss2.tpl', 12, false),array('modifier', 'replace', '/var/www/html/forumrd/lib/pkp/templates/notification/rss2.tpl', 21, false),array('modifier', 'strip', '/var/www/html/forumrd/lib/pkp/templates/notification/rss2.tpl', 21, false),array('modifier', 'date_format', '/var/www/html/forumrd/lib/pkp/templates/notification/rss2.tpl', 28, false),array('function', 'translate', '/var/www/html/forumrd/lib/pkp/templates/notification/rss2.tpl', 17, false),array('function', 'url', '/var/www/html/forumrd/lib/pkp/templates/notification/rss2.tpl', 33, false),)), $this); ?>
<?php echo '<?xml'; ?>
 ...
 : <?php echo ((is_array($_tmp=$this->_tpl_vars['notification']->getDateCreated())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%a, %d %b %Y %T %z") : smarty_modifier_date_format($_tmp, "%a, %d %b %Y %T %z")); ?>
				...
				<description>
					<?php if ($this->_tpl_vars['notification']->getIsLocalized()): ?>
						<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => $this->_tpl_vars['notification']->getContents(),'param' => $this->_tpl_vars['notification']->getParam()), $this);?>

					<?php else: ?>
						<?php echo $this->_tpl_vars['notification']->getContents(); ?>
