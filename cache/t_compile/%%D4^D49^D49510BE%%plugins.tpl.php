<?php /* Smarty version 2.6.26, created on 2016-05-18 13:50:42
         compiled from manager/plugins/plugins.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'manager/plugins/plugins.tpl', 16, false),array('function', 'url', 'manager/plugins/plugins.tpl', 22, false),array('modifier', 'escape', 'manager/plugins/plugins.tpl', 22, false),array('modifier', 'to_array', 'manager/plugins/plugins.tpl', 56, false),array('modifier', 'basename', 'manager/plugins/plugins.tpl', 59, false),)), $this); ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['verb'][1])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
		...
		<?php if ($this->_tpl_vars['plugin']->getCurrentVersion()): ?>
			<a class="action" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'managePlugins','path' => ((is_array($_tmp='upgrade')) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['pluginInstallName']) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['pluginInstallName']))), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.plugins.upgrade"), $this);?>
</a>&nbsp;
			<a class="action" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'managePlugins','path' => ((is_array($_tmp='delete')) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['pluginInstallName']) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['pluginInstallName']))), $this);?>
