<?php /* Smarty version 2.6.26, created on 2016-05-18 13:50:55
         compiled from manager/plugins/managePlugins.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'manager/plugins/managePlugins.tpl', 19, false),array('function', 'url', 'manager/plugins/managePlugins.tpl', 22, false),array('modifier', 'to_array', 'manager/plugins/managePlugins.tpl', 67, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['path'] == 'install'): ?>
	...
	<form method="post" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('path' => 'installPlugin'), $this);?>
...
<?php elseif ($this->_tpl_vars['path'] == 'upgrade'): ?>
	...
	<form method="post" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('path' => ((is_array($_tmp='upgradePlugin')) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['plugin']) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['plugin']))), $this);?>
" enctype="multipart/form-data">		
		<?php if ($this->_tpl_vars['error']): ?>
			<span class="formError"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "form.errorsOccurred"), $this);?>
:</span>
...
<?php elseif ($this->_tpl_vars['path'] == 'delete'): ?>
	...
	<?php if (! $this->_tpl_vars['deleted']): ?>
		...
		<br />
		<form method="post" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('path' => ((is_array($_tmp='deletePlugin')) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['plugin']) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['plugin']))), $this);?>
" enctype="multipart/form-data">		
			<?php if ($this->_tpl_vars['error']): ?>
				<span class="formError"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "form.errorsOccurred"), $this);?>
:</span>
