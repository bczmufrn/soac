<?php /* Smarty version 2.6.26, created on 2016-04-05 12:14:28
         compiled from author/submit/step2.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'author/submit/step2.tpl', 19, false),array('function', 'translate', 'author/submit/step2.tpl', 23, false),array('function', 'fieldLabel', 'author/submit/step2.tpl', 69, false),array('modifier', 'escape', 'author/submit/step2.tpl', 20, false),array('modifier', 'to_array', 'author/submit/step2.tpl', 40, false),array('modifier', 'date_format', 'author/submit/step2.tpl', 52, false),)), $this); ?>

<?php if (! $this->_tpl_vars['showAbstractSteps']): ?>
	<?php $this->assign('pageTitle', "author.submit.step2NoAbstracts"); ?>
<?php else: ?>
...
<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "author.submit.uploadInstructions"), $this);?>
...
<tr valign="top">
	...
	<td width="80%" class="value"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'download','path' => ((is_array($_tmp=$this->_tpl_vars['paperId'])) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['submissionFile']->getFileId()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['submissionFile']->getFileId()))), $this);?>
