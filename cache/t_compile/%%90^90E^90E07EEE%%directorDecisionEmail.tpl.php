<?php /* Smarty version 2.6.26, created on 2016-04-05 18:30:37
         compiled from submission/comment/directorDecisionEmail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'submission/comment/directorDecisionEmail.tpl', 32, false),array('modifier', 'assign', 'submission/comment/directorDecisionEmail.tpl', 52, false),array('function', 'translate', 'submission/comment/directorDecisionEmail.tpl', 48, false),array('function', 'fieldLabel', 'submission/comment/directorDecisionEmail.tpl', 65, false),)), $this); ?>
...
<?php endif; ?>
<?php if ($this->_tpl_vars['isADirector']): ?>
	<tr valign="top">
		<td colspan="2">&nbsp;</td>
	</tr>
	<tr valign="top">
...
<?php if ($this->_tpl_vars['isADirector']): ?><input type="checkbox" name="blindCcReviewers" value="1" id="blindCcReviewers"/>&nbsp;&nbsp;<label for="blindCcReviewers"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.comments.blindCcReviewers"), $this);?>
</label><?php endif; ?>
