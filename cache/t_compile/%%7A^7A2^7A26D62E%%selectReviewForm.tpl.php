<?php /* Smarty version 2.6.26, created on 2016-04-05 11:01:20
         compiled from trackDirector/selectReviewForm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'trackDirector/selectReviewForm.tpl', 13, false),array('function', 'url', 'trackDirector/selectReviewForm.tpl', 31, false),array('function', 'page_info', 'trackDirector/selectReviewForm.tpl', 47, false),array('function', 'page_links', 'trackDirector/selectReviewForm.tpl', 48, false),array('block', 'iterate', 'trackDirector/selectReviewForm.tpl', 27, false),array('modifier', 'escape', 'trackDirector/selectReviewForm.tpl', 29, false),array('modifier', 'to_array', 'trackDirector/selectReviewForm.tpl', 31, false),)), $this); ?>
<?php $this->assign('pageTitle', "editor.paper.reviewForms"); ?>
...
<h3><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "editor.paper.selectReviewForm"), $this);?>
</h3>
...
<?php else: ?><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'selectReviewForm','path' => ((is_array($_tmp=$this->_tpl_vars['paperId'])) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['reviewId'], $this->_tpl_vars['reviewForm']->getId()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['reviewId'], $this->_tpl_vars['reviewForm']->getId()))), $this);?>
